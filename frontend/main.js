const {app, BrowserWindow, Menu} = require('electron') //importamos lo necesario para trabajar ocn electron
...
function createWindow () { //aqui procedemos a crear la ventana
  ...
  win.loadURL(url.format({
    pathname: path.join(__dirname, 'dist/compras/index.html'), //esta es la ruta de nuestro index luego de compilar en Angular
    protocol: 'file:',
    slashes: true
  }))
